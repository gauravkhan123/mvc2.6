...
/////////////////establish db Connection ends			
			...
			$sel_sql = "SELECT * FROM `article_orders` WHERE 1 AND `order_id` = '$id'";
    ...
    $sql = "SELECT COUNT(*) FROM article_orders WHERE txn_id = '$txn_id'";
    $r = mysql_query($sql);
...
$s = '<HTML>
 <HEAD>
  <TITLE> International Knowledge Press - Purchase Confirmation</TITLE>
 </HEAD>
 <BODY>
  <P>Dear customer,</P>

<P>Thanks for your order and payment. Link of the purchased paper is available below.</P>

<P><a href="'.$link.'">Download the paper.</a></P>
