...
class Backend_Journals_aip extends Secure_Controller {
	...
	function __construct()
	{
		...
		$this->table 			= "journals";
		$this->title 			= "Article in Press - Journals";
		$this->title_plural		= $this->title.'';
		$this->db_id 			= "Id";
		$this->controller 		= $this->config->item('backend').'/journals_aip';
		$this->alias			= "";
		$this->view_folder		= "backend/content/journals_aip/";
	...
	public function edit($id)
	{
		...
		{	
			...
			if($this->input->post('submit')!='')
			{
					...
					$this->form_validation->set_rules('article_press', 'article_press', 'trim');
