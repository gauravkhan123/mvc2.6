...
class Backend_Misc_Meta extends Secure_Controller {
	...
	function __construct()
	{
		...
		$this->title 			= "Meta Tags Misc.";
		$this->title_plural		= $this->title.'';
		$this->db_id 			= "Id";
		$this->controller 		= $this->config->item('backend').'/misc_meta';
		$this->alias			= "";
		$this->view_folder		= "backend/seo/misc_meta/";
	...
	public function view($id)
	{
		...
		{	
			...
			$data['data'] = $this->basic_model->view_record(array('fullurl','title_tag','meta_keyword_tag','meta_desc_tag'),$this->table,$this->db_id,$id);	
