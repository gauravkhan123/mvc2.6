...
class Backend_Subscribers extends Secure_Controller {
	...
	function __construct()
	{
		...
		$this->db_id 			= "id";
		$this->controller 		= $this->config->item('backend').'/subscribers';
		$this->alias			= "";
		$this->view_folder		= "backend/subscribers/";
	...
	{
		$data['coloums'] = $this->basic_model->list_result(array('id','name','username','institute_name','contact_no','publish'),$this->table);
