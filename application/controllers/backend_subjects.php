...
class Backend_Subjects extends Secure_Controller {

	function __construct()
	{
		parent::__construct();

		$this->table 			= "categories_spl";
		$this->title 			= "Subject";
		$this->title_plural		= $this->title.'s';
		$this->db_id 			= "Id";
		$this->controller 		= $this->config->item('backend').'/subjects';
		$this->alias			= "name";
		$this->view_folder		= "backend/content/subjects/";
	...
	{
		$data['coloums'] = $this->basic_model->list_result(array('Id','name','alias','serial','publish'),$this->table);
	...
	public function view($id)
	{
		...
		{	
			...
			$data['data'] = $this->basic_model->view_record(array('name','alias','serial'),$this->table,$this->db_id,$id);	
