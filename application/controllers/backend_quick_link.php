...
class Backend_Quick_Link extends Secure_Controller {

	function __construct()
	{
		parent::__construct();

		$this->table 			= "quicklinks";
		$this->title 			= "Quick Link";
		$this->title_plural		= $this->title.'';
		$this->db_id 			= "Id";
		$this->controller 		= $this->config->item('backend').'/quick_link';
		$this->alias			= "";
		$this->view_folder		= "backend/menus/quick_link/";
