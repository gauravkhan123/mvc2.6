...
class Backend_books_category extends Secure_Controller {
...

	{
		...
		$this->controller 		= $this->config->item('backend').'/books_category';

		$this->alias			= "name";

		$this->view_folder		= "backend/books_category/";		
...

	{
		...
		{	
...

			{
					...
					$this->form_validation->set_rules('name', 'books Title', 'trim|required');
