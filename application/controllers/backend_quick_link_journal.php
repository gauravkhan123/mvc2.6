...
class Backend_Quick_Link_Journal extends Secure_Controller {

	function __construct()
	{
		parent::__construct();

		$this->table 			= "quicklinks_journal";
		$this->title 			= "Quick Link Journal";
		$this->title_plural		= $this->title.'';
		$this->db_id 			= "Id";
		$this->controller 		= $this->config->item('backend').'/quick_link_journal';
		$this->alias			= "";
		$this->view_folder		= "backend/menus/quick_link_journal/";

		$this->first_field		= "title";
	...
	{
		$data['coloums'] = $this->basic_model->list_result(array($this->db_id,'title','link','serial','publish'),$this->table);
	...
	public function add()
	{
			...
			if($this->input->post('submit')!='')
			{
					...
					$this->form_validation->set_rules('link', 'Link Url', 'trim|required');						
					$this->form_validation->set_rules('serial', 'Title Tag', 'trim');
	...
	public function view($id)
	{
		...
		{	
			...
			$data['data'] = $this->basic_model->view_record(array('title','link','serial'),$this->table,$this->db_id,$id);	
