...
class Backend_Email_Templates extends Secure_Controller {
	...
	function __construct()
	{
		...
		$this->db_id 			= "Id";
		$this->controller 		= $this->config->item('backend').'/email_templates';
		$this->alias			= "";
		$this->view_folder		= "backend/email_templates/";		
	...
	public function index()
	{
		...
		$data['coloums'] = $this->basic_model->list_result(array('Id','title','subject','publish'),$this->table);		
