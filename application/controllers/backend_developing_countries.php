...
class Backend_Developing_Countries extends Secure_Controller {
	...
	function __construct()
	{
		...
		$this->title 			= "Developing Countries";
		$this->title_plural		= $this->title.'s';
		$this->db_id 			= "Id";
		$this->controller 		= $this->config->item('backend').'/developing_countries';
		$this->alias			= "";
		$this->view_folder		= "backend/content/countries/";
	...
	{
		$data['coloums'] = $this->basic_model->list_result(array('Id','name','developing_country','publish'),$this->table);
	...
	public function add()
	{
			...
			if($this->input->post('submit')!='')
			{
					...
					$this->form_validation->set_rules('developing_country', 'Developing Counry', 'trim');					
	...
	public function view($id)
	{
		...
		{	
			...
			$data['data'] = $this->basic_model->view_record(array('name','developing_country'),$this->table,$this->db_id,$id);	
