...
?>
                                      <fieldset>
                                        ...
                                        <div class="control-group">
                                          <label class="control-label" for="name"><span class="error">*</span> Books Title </label>
                                          <div class="controls">
                                            <input class="input-xlarge span6" id="name" name="name" type="text" placeholder="Books Title" value="<?php echo set_value('name',isset($data['name'])?$data['name']:''); ?>">
