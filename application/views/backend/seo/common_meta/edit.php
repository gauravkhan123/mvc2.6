...
?>
                                      <fieldset>
                                        ...
                                        <div class="control-group">
                                          <label class="control-label" for="name"><span class="error">*</span> Full Url </label>
                                          <div class="controls">
                                            <input class="input-xlarge span6" id="fullurl" name="fullurl" type="text" placeholder="Page Title" value="<?php echo set_value('fullurl',isset($data['fullurl'])?$data['fullurl']:''); ?>" disabled="disabled">
                                            <?php echo form_error('fullurl','<span class="error-advise">','</span>'); ?>
                                          </div>
                                        </div>
                                        <div class="control-group">
                                        ...
                                        <div class="control-group">
                                          <label class="control-label" for="meta_desc_tag">Replacers</label>
                                          <div class="controls">
                                            <textarea readonly="readonly" name="replacers" id="replacers" class="span6" placeholder="Replacers" style="
                                            height:180px;"><?php echo set_value('replacers',isset($data['replacers'])?$data['replacers']:''); ?></textarea>
                                            <?php echo form_error('replacers','<span class="error-advise">','</span>'); ?>                                          </div>
                                        </div>                                         
<?php 
