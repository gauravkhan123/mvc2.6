...
?>
                                      <fieldset>
                                        ...
                                        <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input class="input-xlarge span6" id="fullurl" name="fullurl" type="text" placeholder="Page Title" value="<?php echo set_value('fullurl',isset($data['fullurl'])?$data['fullurl']:''); ?>">
