...
<div class="control-group">
                                  ...
                                  <div class="controls">
                                    ...
                                    <?php echo form_error('password','<span class="error-advise">','</span>'); ?>
                                        ...
                                        <div class="control-group">
                                          <label class="control-label" for="username"><span class="error">*</span> Email </label>
                                          <div class="controls">
                                            <input class="input-xlarge span6" id="email" name="email" type="text" placeholder="Email" value="<?php echo set_value('email',isset($data['email'])?$data['email']:''); ?>">
