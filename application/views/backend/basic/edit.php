...
?>
                                      <fieldset>
                                        ...
                                        <div class="control-group">
                                          <label class="control-label" for="name"><span class="error">*</span> Page Title </label>
                                          <div class="controls">
                                            <input class="input-xlarge span6" id="name" name="name" type="text" placeholder="Page Title" value="<?php echo set_value('name',isset($data['name'])?$data['name']:''); ?>">
                                        ...
                                        <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <textarea class="ckeditor_full" id="description" name="description"><?php echo set_value('description',isset($data['description'])?$data['description']:''); ?></textarea>
