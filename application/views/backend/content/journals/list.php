...
?>                                                  
                                                ...
                                                <td><?php echo get_corresponing_value('categories_spl','name',$value['main_cat'],'Id');?></td>
                                                <td><?php echo $value['name'];?></td>                                                
                                                <td><?php echo $value['short_name'];?></td>      
                                                <td><?php echo ($value['upcoming']==1)?'<span class="label label-success">Yes</span>':'<span class="label label-important">No</span>';?></td>                  
                                                                                            <td><?php echo ($value['featured']==1)?'<span class="label label-success">Yes</span>':'<span class="label label-important">No</span>';?></td>                         
