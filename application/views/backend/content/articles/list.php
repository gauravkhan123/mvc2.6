                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered">
										<thead>
											<tr>
                                                ...
                                                <th>Manuscript No.</th>
                                                <th>Article Name</th>                                                
                                                <th>Journal Name > Year > Volume</th>
                                                <th>Article Type</th>                                                
                                           		<th>Active</th>                                                
                                                <th>Actions</th>                                            
											</tr>
										...
										<tbody>
											...
											<tr class="odd gradeX">
                                                ...
                                                <td><input type="text" name="manuscript_no" id="manuscript_no" value="<?php echo @$getvars['manuscript_no'];?>" class="span6" /></td>
                                                <td><input type="text" name="name" id="name" value="<?php echo @$getvars['name'];?>" class="span6" /></td>
...
?>                                               
                                                    ...
                                                    <select id="volume" name="volume" style="width:80px;">
                                                      <option value="" >Select</option>
        <?php
            $cond = "";
        ...
        ?>                                               
                                                    ...
                                                    <select id="sub_cat" name="sub_cat" style="width:160px;">
                                              <option value="" >Select</option>
<?php
	$cond = "";
...
$issues = get_few_record("select Id,name from issues WHERE 1 AND publish = '1' $cond group by name order by name");
	 ...
	 if(!empty($issues))
	{
		...
		{
?>                                              
                                              <option value="<?php echo $value['Id'];?>" <?php if($value['Id'] == @$getvars['sub_cat']) { echo 'selected="selected"'; } ?>><?php echo $value['name'];?></option>
<?php
		}
	}
?>                                               
                                                ...
                                                <td><select id="article_type" name="article_type" style="width:160px;">
                                              <option value="" >Select</option>
<?php



$article_type = get_few_record("select * from article_type WHERE 1 AND publish = '1' order by name");

	 if(!empty($article_type))
	{
		foreach($article_type as $value)
		{
?>                                              
                                              <option value="<?php echo $value['alias'];?>" <?php if($value['alias'] == @$getvars['article_type']) { echo 'selected="selected"'; } ?>><?php echo $value['name'];?></option>
<?php
		}
	}
?>                                               
...
?>                                                 
                                                ...
                                                <th>DB Id</th>
                                                <th>Manuscript No.</th>
                                                 <th width="300">Article Name</th>
                                                <th width="300">Journal > Year > Volume > Issues</th>                                                
                                                 <th>Aricle Type</th> 
                                                 <th>Date</th>
...
?>                                                  
                                                ...
                                                <td><?php echo $value['manuscript_no'];?></td>
                                                <td><?php echo $value['name'];?></td>                                                
                                                <td><?php echo get_corresponing_value('journals','name',$value['main_cat'],'Id')." > Year: " .$value['year']." > Volume: " .$value['volume']." > Issue: " . get_corresponing_value('issues','name',$value['sub_cat'],'Id');?></td>
...
?>                                          
											<tr class="odd gradeX">
                                                <td colspan="10" style="text-align:center;"><?php echo $pagination;?></td>                                
											</tr>                                          							
											<tr class="odd gradeY">
                                                <td colspan="10" style="text-align:center;">You are seeing <?php echo $startvalue;?> to <?php echo $endvalue;?> of total <?php echo $totalvalue;?> records</td>                                
											</tr> 
...
///////////getting values on change
		...
		$( "#filterButton" ).click(function() 		
		{
			...
			window.location.href = '<?php echo site_url('siteowner/articles/listing');?>/'+'filter-Id:'+Id+'-manuscript_no:'+manuscript_no+'-name:'+name+'-main_cat:'+main_cat+'-year:'+year+'-volume:'+volume+'-sub_cat:'+sub_cat+'-article_type:'+article_type+'-publish:'+publish;
