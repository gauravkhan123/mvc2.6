...
?>
                                  ...
                                  <div class="control-group">
                                          <label class="control-label" for="name"><span class="error">*</span> Image [990x140]</label>
                                          <div class="controls">
                                            <input class="input-xlarge span6" id="image" name="image" type="file" placeholder="Docuemnt" value="<?php echo set_value('image',isset($data['image'])?$data['image']:''); ?>">
<?php
if($id)
{
?>                                                 
                                            <a href="<?php echo base_url().'media/slider/big/'.$data['image']; ?>" title="<?php echo $data['name'];?>" target="_blank"><img src="<?php echo base_url().'media/slider/thumb/'.$data['image']; ?>" alt="<?php echo $data['name']?>" /></a>
<?php
}
?>                                            
...
<div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input class="input-xlarge span6" id="url" name="url" type="text" placeholder="URL" value="<?php echo set_value('url',isset($data['url'])?$data['url']:''); ?>">
                                            <?php echo form_error('url','<span class="error-advise">','</span>'); ?>
                                          </div>
                                        </div>                                        
