...
?>                                                  
                                                ...
                                                <td><a href="<?php echo base_url().'media/slider/big/'.$value['image']; ?>" title="<?php echo $value['name'];?>" target="_blank"><img src="<?php echo base_url().'media/slider/thumb/'.$value['image']; ?>" alt="<?php echo $value['name']?>" /></a></td>      
