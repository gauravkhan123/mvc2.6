...
?>
                                      <fieldset>
                                        ...
                                        <div class="control-group">
                                          <label class="control-label" for="developing_country">Developing Country?</label>
                                          <div class="controls">
											<select id="developing_country" name="developing_country" class="span6">
                                              <option value="1" <?php if("1" === set_value('developing_country',isset($data['developing_country'])?$data['developing_country']:'')) { echo 'selected="selected"'; } ?>>Yes</option>
                                              <option value="0" <?php if("0" === set_value('developing_country',isset($data['developing_country'])?$data['developing_country']:'')) { echo 'selected="selected"'; } ?>>No</option>
                                            </select>
                                          </div>
                                        </div>
