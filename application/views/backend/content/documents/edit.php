...
?>
                                      <fieldset>
                                        ...
                                        <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input class="input-xlarge span6" id="title" name="title" type="text" placeholder="Name" value="<?php echo set_value('title',isset($data['title'])?$data['title']:''); ?>">
                                            <?php echo form_error('title','<span class="error-advise">','</span>'); ?>
                                          </div>
                                        </div>
                                                                                
                                  <div class="control-group">
                                          <label class="control-label" for="name"><span class="error">*</span> Document </label>
                                          <div class="controls">
                                            <input class="input-xlarge span6" id="ms_word_file" name="ms_word_file" type="file" placeholder="Docuemnt" value="<?php echo set_value('ms_word_file',isset($data['ms_word_file'])?$data['ms_word_file']:''); ?>">
<?php
if($id)
{
?>                                                 
                                            <a href="<?php echo base_url().'media/documents/'.$data['ms_word_file']; ?>" title="<?php echo $data['title'];?>"><?php echo $data['ms_word_file']?></a>
<?php
}
?>                                            
