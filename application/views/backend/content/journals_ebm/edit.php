...
<div class="control-group">
                                        ...
                                        <div class="control-group">
                                          <label class="control-label" for="announcement"><span class="error">*</span> Editorial Board Members</label>
                                          <div class="controls">
                                            <textarea class="ckeditor_full" id="editorial_board_members" name="editorial_board_members"><?php echo set_value('editorial_board_members',isset($data['editorial_board_members'])?$data['editorial_board_members']:''); ?></textarea>
                                            <?php echo form_error('editorial_board_members','<span class="help-inline">','</span>'); ?>
                                          </div>
                                        </div>                          
