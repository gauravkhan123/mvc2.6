...
?>
                                      <fieldset>
                                        ...
                                        <div class="control-group">
                                          <label class="control-label" for="Special Editor"> Special Editor</label>
                                          <div class="controls">
											<select id="special_editor_id" name="special_editor_id" class="span6">
                                              <option value="" >Select</option>
<?php if(!empty($specialeditors))
{
	foreach($specialeditors as $value)
	{
?>                                              
                                              <option value="<?php echo $value['Id'];?>" <?php if($value['Id'] == set_value('special_editor_id',isset($data['special_editor_id'])?$data['special_editor_id']:'')) { echo 'selected="selected"'; } ?>><?php echo $value['name'];?></option>
<?php
	}
}
?>                                               
                                        ...
                                        <div class="control-group">
                                          <label class="control-label" for="Author Name"> <span class="error">*</span> Author Name</label>
                                          <div class="controls">
											<select id="author_id" name="author_id" class="span6">
                                              <option value="" >Select</option>
<?php if(!empty($specialeditors))
{
	foreach($specialeditors as $value)
	{
?>                                              
                                              <option value="<?php echo $value['Id'];?>" <?php if($value['Id'] == set_value('author_id',isset($data['author_id'])?$data['author_id']:'')) { echo 'selected="selected"'; } ?>><?php echo $value['name'];?></option>
<?php
	}
}
?>                                               
...
<div class="control-group">
									...
									<div class="control-group">
										...
										<div class="control-group">
                                          <label class="control-label" for="rv_name_e"><span class="error">*</span> Name </label>
                                          <div class="controls">
										...
										<div class="control-group">
                                          <label class="control-label" for="rv_address_e"><span class="error">*</span> Address </label>
                                          <div class="controls">
                                        ...
                                        <div class="control-group">
                                          <label class="control-label" for="rv_email_e"><span class="error">*</span> Email </label>
                                          <div class="controls">
										...
										<div class="control-group">
                                          <label class="control-label" for="rv_name_f"><span class="error">*</span> Name </label>
                                          <div class="controls">
										...
										<div class="control-group">
                                          <label class="control-label" for="rv_address_f"><span class="error">*</span> Address </label>
                                          <div class="controls">
                                        ...
                                        <div class="control-group">
                                          <label class="control-label" for="rv_email_f"><span class="error">*</span> Email </label>
                                          <div class="controls">
...
?>
										...
										<div class="control-group">
                                          <label class="control-label" for="assign_reviewer1"><span class="error">*</span>Assign Reviewer 1 </label>
                                          <div class="controls">
										...
										<div class="control-group">
                                          <label class="control-label" for="assign_reviewer2"><span class="error">*</span>Assign Reviewer 2 </label>
                                          <div class="controls">
                                        ...
                                        <div class="control-group">
                                          <label class="control-label" for="assign_reviewer3"><span class="error">*</span>Assign Reviewer 3 </label>
                                          <div class="controls">
										...
										<div class="control-group">
                                          <label class="control-label" for="assign_reviewer4"><span class="error">*</span>Assign Reviewer 4 </label>
                                          <div class="controls">
...
///////////getting values on change
		...
		{
			$.post( "<?php echo site_url('siteowner/manuscripts/getjournal');?>", { subject_id: this.value })
			.done(function( data ) 
			{
