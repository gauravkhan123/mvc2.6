...
<form action="<?php echo site_url($current_controller.'/bulkaction');?>" method="post" id="frm_bulkaction">                            
                                <div class="span12">
<?php 
...
?>    								                         
												...
												<td><?php echo get_corresponing_value('books_categories','name',$value['books_category_id'],'id')?></td>	
                                                <td><?php echo ($value['publish']==1)?'<span class="label label-success">Yes</span>':'<span class="label label-important">No</span>';?></td>                                                
												<td>
<?php 
	if($this->action_view)
	{
...
<?php else:?>                                                      
                                                <i class="icon-ban-circle" title="Inactive" data-toggle="modal"
												 href="#myInactiveAlert_<?php echo $value[$this->db_id];?>" style="cursor:pointer;"></i>&nbsp;
