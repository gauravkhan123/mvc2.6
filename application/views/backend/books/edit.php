...
?>
                                      <fieldset>
										...
										<div class="control-group">
                                          <label class="control-label" for="category">Books Category</label>
                                          <div class="controls">
											<select id="books_category_id" name="books_category_id">
											  ...
											  <?php if(!empty($categories))
{
	...
	{
?>                                              
                                              <option value="<?php echo $value['id'];?>" <?php if($value['id'] == set_value('books_category_id',isset
											  ($data['books_category_id'])?$data['books_category_id']:'')) { echo 'selected="selected"'; } ?>>
...
?>   
                                        ...
                                        <div class="control-group">
                                          <label class="control-label" for="name"><span class="error">*</span> Book Title </label>
                                          <div class="controls">
                                            <input class="input-xlarge span6" id="name" name="name" type="text" placeholder=" Book Title" value="<?php echo set_value('name',isset($data['name'])?$data['name']:''); ?>">
