...
?>                                                  
                                                ...
                                                <td><?php echo manuscriptNo($value['Id']);?></td>
...
<script>
		...
		$( "#filterButton" ).click(function() 		
		{
			...
			window.location.href = '<?php echo site_url('siteowner/manuscripts/listing');?>/'+'filter-year:'+year+'-manuscript_no:'+manuscript_no+'-title:'+title+'-journal_id:'+journal_id+'-author_name:'+author_name+'-author_email:'+author_email+'-author_country:'+author_country+'-wna:'+wna+'-status:'+status+'-todate:'+todate+'-fromdate:'+fromdate;
