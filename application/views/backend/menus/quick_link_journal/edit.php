...
?>
                                      <fieldset>
                                        ...
                                        <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input class="input-xlarge span6" id="title" name="title" type="text" placeholder="Link Name" value="<?php echo set_value('title',isset($data['title'])?$data['title']:''); ?>">
                                        ...
                                        <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input class="input-xlarge span6" id="link" name="link" type="text" placeholder="Link Url" value="<?php echo set_value('link',isset($data['link'])?$data['link']:''); ?>">
                                            <?php echo form_error('link','<span class="error-advise">','</span>'); ?>
                                          </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input class="input-xlarge span6" id="serial" name="serial" type="text" placeholder="Link Position" value="<?php echo set_value('serial',isset($data['serial'])?$data['serial']:''); ?>">
