...
?>
                                      <fieldset>
                                        ...
                                        <div style="height:25px;">
                                        	<input type="checkbox" id="permissions" name="permissions[]" value="<?php echo $value['controller_id'];?>" 
											<?php if(in_array($value['controller_id'],$permissions)) { echo 'checked="checked"'; } ?>  /> <?php echo $value['controller_name'];?>
                                        </div>
                                        <?php
											}
										}
