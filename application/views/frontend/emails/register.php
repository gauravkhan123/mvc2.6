...
<table border="0" align="center" cellpadding="0" cellspacing="0" style=" background:#e7d394;  border:1px solid #474747;">
  ...
  <tr>
    <td colspan="2" height="40"><strong>New Registration - <?php echo $SITENAME;?></strong></td>
  </tr>
  <tr>
    <td colspan="2">Hi, <?php echo $NAME;?><br><br>Welcome to SCIENCEDOMAIN Inernational, click below link to activate your account :</td>
  </tr>
  <tr>
    <td colspan="2"><?php echo $VERIFYLINK;?></td>
  </tr>  
  <tr>
    <td>Your Role</td>
    <td><?php echo str_replace("_", " ", $ROLE);?></td>
  </tr>  
  <tr>
    <td>Username</td>
  ...
  <tr>
    <td>Login Page</td>
    <td><?php echo $LOGINLINK;?></td>
  </tr>      
  <tr>
    <td colspan="2"><strong>Team <?php echo $SITENAME;?></strong></td>
  </tr>
</table>
